...
set_objects( ([
  "obj/elevator_internal_door.scr" : 1,
]) );
set_long("You are in the elevator.  There are four buttons, labeled 'church', 'attic', 'wiz hall', and 'lima'.");
set_state_description("door_on", "\nThere is an open door to the east.\n");
set_state_description("door_off", "\nThere is an closed door to the east.\n");
{
move_to("church");
