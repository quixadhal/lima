...
int direct_cast_str_on_obj ()
{
  return 1;
}

int direct_cast_str_at_obj ()
{
  return 1;
}

int direct_cast_str_with_obj ()
{
  return 1;
}

int direct_cast_str_at_obj_with_obj ()
{
  return 1;
}

int indirect_cast_str_at_obj_with_obj ()
{
  return 1;
}

int direct_cast_str_on_obj_with_obj ()
{
  return 1;
}

int indirect_cast_str_on_obj_with_obj ()
{
  return 1;
}

int direct_cast_str_with_obj_at_obj ()
{
  return 1;
}

int indirect_cast_str_with_obj_at_obj ()
{
  return 1;
}

int direct_cast_str_with_obj_on_obj ()
{
  return 1;
}

int indirect_cast_str_with_obj_on_obj ()
{
  return 1;
}
