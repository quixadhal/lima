...
DOC(complete, "Given a string and a list of possible completions of that string, return an array of all strings that would be valid completions.")
...
DOC(case_insensitive_complete, "same as complete, but upper "
    "and lower case are ignored.")
...
DOC(complete_user, "given a username that might be partial, returns a "
