...
//:MODULE
//
//The remote module offers the call_remote() function for calling
//functions on other muds.

//:FUNCTION call_remote
//allows you to execute a call_other on a remote mud.
...
//:FUNCTION call_broadcast
//allows you to execute a call_other on ALL other muds.
...
//will evaluate and return a result from a remote mud.
...
//:FUNCTION eval_broadcast
//will evaluate and return results from each remote mud.
...
//:FUNCTION auth_call
//perform an authenticated/privileged call to a remote mud, carrying
