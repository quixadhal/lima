...
mapping get_exits() { return exits; }
...
string show_exits() {
    ...
    exit_str = iwrap(sprintf("     exits: %s.\n",exit_str),12);
    return exit_str;
}
...
int move_player(string arg, string dest);
